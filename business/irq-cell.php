<?php
/**
 * PhytoScience Wellness - iiQ Plus™ / IRQ Cell Official Landing Page
...
$product = get_product_by_slug('irq-cell');
if (!$product) {
...
<!-- ========================================================================
     1. HERO SECTION: iiQ PLUS™ / IRQ CELL
======================================================================== -->
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-6 order-lg-1">
        ...
        <div class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-2 mb-4">
          ...
          <a href="https://wa.me/2348023173303?text=<?= urlencode('Hello PhytoScience Team, I am interested in ordering iiQ Plus (IRQ Cell). Please assist me.') ?>" target="_blank" rel="noopener" class="btn-ps btn-ps-emerald py-3 px-3 text-center fs-6 fw-bold">
  ...
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      <span class="badge px-3 py-1 rounded-pill mb-2" style="background: rgba(216, 0, 29, 0.12); color: #FF4D5E; border: 1px solid rgba(216, 0, 29, 0.3); font-size: 0.75rem; font-weight: 700;">
        THE MODERN EPIDEMIC: DIGITAL OVERLOAD & BRAIN FATIGUE
      </span>
      <h2 class="display-6 fw-bold text-white mb-3">Why Your Eyes & Brain <span class="text-danger">Are Exhausted</span></h2>
      <p class="text-secondary">Modern smartphones, computer screens, high-stress work, and toxic free radicals constantly assault our central nervous system and delicate retinal tissues.</p>
    </div>
    ...
    <div class="row g-4 mb-5">
      <div class="col-md-4">
        <div class="ps-problem-card">
          ...
          <h4 class="text-white fw-bold fs-5 mb-2">High-Energy Blue Light Burning</h4>
          <p class="text-secondary small mb-0">Phone and laptop screens emit shortwave blue light that penetrates directly to the macula, degrading ocular pigments and causing dry eyes, eye pain, and blurry vision.</p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="ps-problem-card">
          ...
          <h4 class="text-white fw-bold fs-5 mb-2">Mental Fog & Memory Decay</h4>
          <p class="text-secondary small mb-0">Chronic multi-tasking depletes essential neurotransmitters. Brain neurons suffer oxidative stress, leading to mid-day fatigue, difficulty concentrating, and forgetfulness.</p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="ps-problem-card">
          ...
          <h4 class="text-white fw-bold fs-5 mb-2">Blood-Brain Barrier Blockade</h4>
          <p class="text-secondary small mb-0">Standard pills and multivitamins cannot cross the physiological blood-brain or blood-retinal barriers. They pass straight through without nourishing neural tissues.</p>
        </div>
      </div>
    </div>
    ...
    <div class="p-4 p-md-5 rounded-4 position-relative overflow-hidden" style="background: radial-gradient(circle at 10% 50%, rgba(216,0,29,0.15) 0%, rgba(18,19,24,0.95) 100%); border: 1px solid rgba(216,0,29,0.3);">
      <div class="row align-items-center g-4">
        <div class="col-lg-8">
          <span class="badge px-3 py-1 rounded-pill mb-2" style="background: #2ECC71; color: #000; font-weight: 800; font-size: 0.72rem;">THE CLINICAL NOOTROPIC BREAKTHROUGH</span>
          <h3 class="text-white fw-bold display-6 fs-3 mb-3">How iiQ Plus™ Protects Your Mind & Eyes</h3>
  ...
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      <span class="badge px-3 py-1 rounded-pill mb-2" style="background: rgba(198, 164, 92, 0.15); color: #C6A45C; border: 1px solid rgba(198, 164, 92, 0.3); font-size: 0.75rem; font-weight: 700;">
        CLINICALLY RESEARCHED NOOTROPIC EFFICACY
      </span>
      <h2 class="display-6 fw-bold text-white mb-3">6 Core Transformations from <span class="text-gold">iiQ Plus™</span></h2>
      <p class="text-secondary">Engineered with FloraGLO® Lutein, Astaxanthin, and berry polyphenols to fortify mental acuity and vision resilience.</p>
    </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="ps-benefit-card">
            <div class="ps-benefit-icon-box">
              <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
            </div>
...
<section class="py-5 position-relative" style="background: #101116;" id="comparison">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Conventional Eye Drops & Caffeine vs <span class="text-gold">iiQ Plus™</span></h2>
      <p class="text-secondary">Understand why top performers, students, and seniors choose authentic cellular nutrition over short-lived stimulants.</p>
    </div>
      ...
      <table class="ps-compare-table">
        <thead>
          <tr>
            ...
            <th style="width: 35%; color: #8C8E99;">Standard Caffeine & Chemical Drops</th>
            <th class="highlight-col" style="width: 35%; font-size: 1.05rem;">
              <span class="text-gold">★</span> iiQ Plus™ (IRQ Cell)
            </th>
          </tr>
        </thead>
        <tbody>
    ...
    <div class="text-center max-w-700 mx-auto mb-4">
      ...
      <p class="text-secondary small">Clinically verified ingredients extracted through patented nutritional biotechnology.</p>
    </div>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="gallery">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">iiQ Plus™ <span class="text-gold">Visual Showcase</span></h2>
      <p class="text-secondary">Explore the packaging, tamper-proof seal, Swiss quality marks, and liquid sachet format. Click any image to view in high-resolution lightbox.</p>
    </div>

    <div class="row g-4 justify-content-center">
      <div class="col-lg-3 col-6">
        <div class="ps-gallery-card js-image-trigger" data-img-src="<?= asset(ltrim($product['image'], '/')) ?>" data-img-caption="iiQ Plus™ (IRQ Cell) — Official Packaging & Holographic Seal">
          <img src="<?= asset(ltrim($product['image'], '/')) ?>" alt="iiQ Plus Box" loading="lazy">
      ...
      <div class="col-lg-3 col-6">
        <div class="ps-gallery-card js-image-trigger" data-img-src="<?= asset('images/logo.png') ?>" data-img-caption="FloraGLO® Verified Lutein & Zeaxanthin Quality Seal">
          <img src="<?= asset('images/logo.png') ?>" alt="FloraGLO Certification" loading="lazy">
          <div class="ps-gallery-zoom-overlay">
            <div class="ps-gallery-zoom-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line><line x1="11" y1="8" x2="11" y2="14"></line><line x1="8" y1="11" x2="14" y2="11"></line></svg>
            </div>
        ...
        <div class="text-center mt-2">
          <span class="text-white small fw-semibold">FloraGLO® Lutein Patent</span>
        </div>
      </div>

      <div class="col-lg-3 col-6">
        <div class="ps-gallery-card js-image-trigger" data-img-src="<?= asset('images/testimonies/cancer-testimonies.png') ?>" data-img-caption="Documented Patient Brain & Vision Improvement Records">
  ...
  <div class="container">
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-7">
        ...
        <h2 class="display-6 fw-bold text-white mb-3">How to Take for <span class="text-gold">Maximum Neural & Visual Benefit</span></h2>
        <p class="text-secondary mb-4">iiQ Plus™ comes in ready-to-drink liquid sachets for rapid digestive uptake and gentle systemic bioavailability.</p>
        ...
        <div class="d-flex flex-column gap-3 mb-4">
          ...
          <div class="p-3 rounded-3 d-flex gap-3 align-items-start" style="background: rgba(24,25,32,0.6); border: 1px solid rgba(255,255,255,0.08);">
            ...
            <div>
              <h5 class="text-white fw-bold fs-6 mb-1">Optimal Concentration Tip</h5>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="video-proof">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <p class="text-secondary">Explore real video accounts of increased focus, reduced eye strain, and physical vitality with PhytoScience.</p>
    </div>
...
<section class="py-5 position-relative" style="background: #101116;" id="reviews">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Rated <span class="text-gold"><?= $product['rating'] ?>/5.0</span> by Students, Professionals & Seniors</h2>
      <p class="text-secondary">Read authentic stories of mental clarity, reduced blue-light strain, and improved visual comfort.</p>
    </div>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="faq">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Everything You Need to Know About <span class="text-crimson">iiQ Plus™</span></h2>
  ...
  <div class="container">
    <div class="max-w-800 mx-auto">
      <span class="badge px-3 py-2 rounded-pill mb-3" style="background: rgba(198, 164, 92, 0.15); color: #C6A45C; border: 1px solid rgba(198, 164, 92, 0.3); font-size: 0.8rem; font-weight: 700;">
        TAKE CHARGE OF YOUR BRAIN & EYE WELLNESS TODAY
      </span>
      <h2 class="display-5 fw-bold text-white mb-3">Sharpen Your Mind & Shield Your Eyes with <span class="text-crimson">iiQ Plus™</span></h2>
      <p class="text-secondary lead fs-6 mb-4">
        Join students, business leaders, and proactive families across 41+ nations who protect their memory and vision every day with FloraGLO® Lutein and Astaxanthin nootropic liquid sachets.
      </p>
      ...
      <div class="d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4">
        ...
        <a href="https://wa.me/2348023173303?text=<?= urlencode('Hello PhytoScience Team, I am on the iiQ Plus (IRQ Cell) page and would like to order or consult.') ?>" target="_blank" rel="noopener" class="btn-ps btn-ps-emerald py-3 px-4 fs-6 fw-bold">
