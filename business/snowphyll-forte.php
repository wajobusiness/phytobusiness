<?php
/**
 * PhytoScience Wellness - Snowphyll Forte™ Official Landing Page
...
$product = get_product_by_slug('snowphyll-forte');
if (!$product) {
...
<!-- ========================================================================
     1. HERO SECTION: SNOWPHYLL FORTE™
======================================================================== -->
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-6 order-lg-2">
        <div class="ps-prod-img-stage">
          ...
          <img src="<?= asset(ltrim($product['image'], '/')) ?>" alt="<?= htmlspecialchars($product['name']) ?>" class="img-fluid" width="1000" height="572">
      ...
      <div class="col-lg-6 order-lg-1">
        ...
        <div class="p-3 rounded-3 mb-4" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08);">
          ...
          <div class="ps-hero-price-wrap my-1">
            ...
            <span class="ps-hero-save-badge">SAVE ₦10,000 (22% OFF)</span>
          </div>
        ...
        <div class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-2 mb-4">
          ...
          <a href="https://wa.me/2348023173303?text=<?= urlencode('Hello PhytoScience Team, I am interested in ordering Snowphyll Forte. Please assist me.') ?>" target="_blank" rel="noopener" class="btn-ps btn-ps-emerald py-3 px-3 text-center fs-6 fw-bold">
  ...
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      <span class="badge px-3 py-1 rounded-pill mb-2" style="background: rgba(216, 0, 29, 0.12); color: #FF4D5E; border: 1px solid rgba(216, 0, 29, 0.3); font-size: 0.75rem; font-weight: 700;">
        INTERNAL TOXIN OVERLOAD & ACIDIC BLOOD MATRIX
      </span>
      <h2 class="display-6 fw-bold text-white mb-3">Why Teas & Laxatives <span class="text-danger">Never Detoxify Your Blood</span></h2>
      <p class="text-secondary">Commercial detox teas simply act as harsh gut laxatives, irritating intestinal walls while leaving heavy metals, systemic acidity, and blood impurities completely untouched.</p>
    </div>
    ...
    <div class="row g-4 mb-5">
      <div class="col-md-4">
        <div class="ps-problem-card">
          ...
          <h4 class="text-white fw-bold fs-5 mb-2">Acidic Blood & Low Oxygen</h4>
          <p class="text-secondary small mb-0">High-sugar diets, carbonated drinks, and processed oils drop blood pH, starving red blood cells of oxygen and causing chronic brain fog, migraines, and fatigue.</p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="ps-problem-card">
          ...
          <h4 class="text-white fw-bold fs-5 mb-2">Sluggish Lymphatic Clearing</h4>
          <p class="text-secondary small mb-0">Toxins accumulate in the liver and lymphatic nodes, creating systemic body odor, persistent halitosis, digestive bloating, and sudden skin breakouts.</p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="ps-problem-card">
          ...
          <h4 class="text-white fw-bold fs-5 mb-2">Microbiome Deterioration</h4>
          <p class="text-secondary small mb-0">Chemical preservatives and prescription antibiotics eradicate beneficial intestinal flora, causing severe constipation, acid reflux, and metabolic stagnation.</p>
        </div>
      </div>
    </div>
    ...
    <div class="p-4 p-md-5 rounded-4 position-relative overflow-hidden" style="background: radial-gradient(circle at 10% 50%, rgba(216,0,29,0.15) 0%, rgba(18,19,24,0.95) 100%); border: 1px solid rgba(216,0,29,0.3);">
      <div class="row align-items-center g-4">
        <div class="col-lg-8">
          <span class="badge px-3 py-1 rounded-pill mb-2" style="background: #2ECC71; color: #000; font-weight: 800; font-size: 0.72rem;">MOLECULAR BLOOD RESTORATION</span>
          <h3 class="text-white fw-bold display-6 fs-3 mb-3">How Snowphyll Forte™ Rebuilds Red Blood Cells</h3>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="benefits">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">6 Core Transformations from <span class="text-gold">Snowphyll Forte™</span></h2>
      <p class="text-secondary">Extracted from premium Mulberry leaves and fortified with snow algae to purify the bloodstream, normalize digestion, and balance body alkalinity.</p>
    </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="ps-benefit-card">
            <div class="ps-benefit-icon-box">
              <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg>
            </div>
...
<section class="py-5 position-relative" style="background: #101116;" id="comparison">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Ordinary Green Juices vs <span class="text-gold">Snowphyll Forte™</span></h2>
      <p class="text-secondary">Understand the difference between non-standardized powders and pharmaceutical-grade chlorophyllin.</p>
    </div>
      ...
      <table class="ps-compare-table">
        <thead>
          <tr>
            ...
            <th style="width: 35%; color: #8C8E99;">Commercial Green Juices & Teas</th>
            <th class="highlight-col" style="width: 35%; font-size: 1.05rem;">
              <span class="text-gold">★</span> Snowphyll Forte™
            </th>
          </tr>
        </thead>
        <tbody>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="gallery">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Snowphyll Forte™ <span class="text-gold">Visual Showcase</span></h2>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-lg-3 col-6">
        <div class="ps-gallery-card js-image-trigger" data-img-src="<?= asset(ltrim($product['image'], '/')) ?>" data-img-caption="Snowphyll Forte™ — Official Packaging & Holographic Seal">
          <img src="<?= asset(ltrim($product['image'], '/')) ?>" alt="Snowphyll Forte Box" loading="lazy">
      ...
      <div class="col-lg-3 col-6">
        <div class="ps-gallery-card js-image-trigger" data-img-src="<?= asset('images/testimonies/sickle-cell.jpg') ?>" data-img-caption="Sickle Cell Blood Stabilization and Cellular Recovery Records with PhytoScience">
          <img src="<?= asset('images/testimonies/sickle-cell.jpg') ?>" alt="Blood Recovery Proof" loading="lazy">
          <div class="ps-gallery-zoom-overlay">
            <div class="ps-gallery-zoom-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line><line x1="11" y1="8" x2="11" y2="14"></line><line x1="8" y1="11" x2="14" y2="11"></line></svg>
            </div>
  ...
  <div class="container">
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-7">
        ...
        <h2 class="display-6 fw-bold text-white mb-3">How to Take for <span class="text-gold">Whole-Body Cleansing</span></h2>
        <p class="text-secondary mb-4">Dissolve 1 sachet into a bottle of room-temperature or cold water. Sip throughout your morning for continuous detoxification.</p>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="video-proof">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <p class="text-secondary">Watch genuine video accounts of gastrointestinal and blood purification with Snowphyll Forte™.</p>
    </div>
...
<section class="py-5 position-relative" style="background: #101116;" id="reviews">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <p class="text-secondary">Read authentic feedback on gastrointestinal cleansing, body odor elimination, and blood energy.</p>
    </div>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="faq">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Everything You Need to Know About <span class="text-crimson">Snowphyll Forte™</span></h2>
...
<section class="py-5 py-lg-6 position-relative text-center overflow-hidden" style="background: radial-gradient(circle at 50% 50%, rgba(216,0,29,0.22) 0%, rgba(10,11,14,0.98) 75%); border-top: 1px solid rgba(216,0,29,0.3); border-bottom: 1px solid rgba(216,0,29,0.3);">
  <div class="container">
    <div class="max-w-800 mx-auto">
      ...
      <h2 class="display-5 fw-bold text-white mb-3">Purify Your System with <span class="text-crimson">Snowphyll Forte™</span></h2>
      <p class="text-secondary lead fs-6 mb-4">
        Eliminate toxins, alkalize your bloodstream, and restore natural vitality with Swiss-researched chlorophyllin and snow algae.
      </p>
      ...
      <div class="d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4">
        ...
        <a href="https://wa.me/2348023173303?text=<?= urlencode('Hello PhytoScience Team, I am on the Snowphyll Forte page and would like to order or consult.') ?>" target="_blank" rel="noopener" class="btn-ps btn-ps-emerald py-3 px-4 fs-6 fw-bold">
