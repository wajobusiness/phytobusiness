<?php
/**
 * PhytoScience Wellness - Double Stemcell™ Official Landing Page
...
$product = get_product_by_slug('double-stem-cell');
if (!$product) {
...
<!-- ========================================================================
     1. HERO SECTION: DOUBLE STEMCELL™
======================================================================== -->
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-6 order-lg-1">
        ...
        <div class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-2 mb-4">
          ...
          <a href="https://wa.me/2348023173303?text=<?= urlencode('Hello PhytoScience Team, I am interested in ordering Double Stemcell. Please assist me.') ?>" target="_blank" rel="noopener" class="btn-ps btn-ps-emerald py-3 px-3 text-center fs-6 fw-bold">
    ...
    <div class="p-4 p-md-5 rounded-4 position-relative overflow-hidden" style="background: radial-gradient(circle at 10% 50%, rgba(216,0,29,0.15) 0%, rgba(18,19,24,0.95) 100%); border: 1px solid rgba(216,0,29,0.3);">
      <div class="row align-items-center g-4">
        <div class="col-lg-8">
          ...
          <h3 class="text-white fw-bold display-6 fs-3 mb-3">How Double Stemcell™ Solves This at the Cellular Level</h3>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="benefits">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">6 Core Transformations from <span class="text-gold">Double Stemcell™</span></h2>
      <p class="text-secondary">Every single sachet delivers targeted epigenetic bio-nutrients formulated to revive cellular function across major internal biological systems.</p>
    </div>
...
<!-- ========================================================================
     4. WHY CUSTOMERS CHOOSE THIS (COMPARISON MATRIX & INGREDIENT SPOTLIGHT)
======================================================================== -->
<section class="py-5 position-relative" style="background: #101116;" id="comparison">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Conventional Supplements vs <span class="text-gold">Double Stemcell™</span></h2>
      ...
      <table class="ps-compare-table">
        <thead>
          <tr>
            ...
            <th style="width: 35%; color: #8C8E99;">Conventional Pills & Supplements</th>
            <th class="highlight-col" style="width: 35%; font-size: 1.05rem;">
              <span class="text-gold">★</span> Double Stemcell™
            </th>
          </tr>
        </thead>
        <tbody>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="gallery">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Double Stemcell™ <span class="text-gold">Visual Showcase</span></h2>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-lg-3 col-6">
        <div class="ps-gallery-card js-image-trigger" data-img-src="<?= asset(ltrim($product['image'], '/')) ?>" data-img-caption="Double Stemcell™ — Official Packaging & Holographic Seal">
          <img src="<?= asset(ltrim($product['image'], '/')) ?>" alt="Double Stemcell Box" loading="lazy">
  ...
  <div class="container">
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-7">
        ...
        <p class="text-secondary mb-4">Double Stemcell™ is formulated for sublingual absorption (under the tongue), bypassing the stomach entirely.</p>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="faq">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Everything You Need to Know About <span class="text-crimson">Double Stemcell™</span></h2>
...
<section class="py-5 py-lg-6 position-relative text-center overflow-hidden" style="background: radial-gradient(circle at 50% 50%, rgba(216,0,29,0.22) 0%, rgba(10,11,14,0.98) 75%); border-top: 1px solid rgba(216,0,29,0.3); border-bottom: 1px solid rgba(216,0,29,0.3);">
  <div class="container">
    <div class="max-w-800 mx-auto">
      ...
      <h2 class="display-5 fw-bold text-white mb-3">Begin Your Transformation with <span class="text-crimson">Double Stemcell™</span></h2>
      ...
      <div class="d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4">
        ...
        <a href="https://wa.me/2348023173303?text=<?= urlencode('Hello PhytoScience Team, I am on the Double Stemcell page and would like to order or consult.') ?>" target="_blank" rel="noopener" class="btn-ps btn-ps-emerald py-3 px-4 fs-6 fw-bold">
