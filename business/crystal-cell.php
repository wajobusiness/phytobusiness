<?php
/**
 * PhytoScience Wellness - Crystal Cell™ Official Landing Page
...
$product = get_product_by_slug('crystal-cell');
if (!$product) {
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-6 order-lg-2">
        <div class="ps-prod-img-stage">
          ...
          <img src="<?= asset(ltrim($product['image'], '/')) ?>" alt="<?= htmlspecialchars($product['name']) ?>" class="img-fluid" width="600" height="400">
      ...
      <div class="col-lg-6 order-lg-1">
        ...
        <div class="p-3 rounded-3 mb-4" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08);">
          ...
          <div class="ps-hero-price-wrap my-1">
            ...
            <span class="ps-hero-save-badge">SAVE ₦10,000 (19% OFF)</span>
          </div>
        ...
        <div class="d-flex flex-column flex-sm-row align-items-stretch align-items-sm-center gap-2 mb-4">
          ...
          <a href="https://wa.me/2348023173303?text=<?= urlencode('Hello PhytoScience Team, I am interested in ordering Crystal Cell. Please assist me.') ?>" target="_blank" rel="noopener" class="btn-ps btn-ps-emerald py-3 px-3 text-center fs-6 fw-bold">
  ...
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      <span class="badge px-3 py-1 rounded-pill mb-2" style="background: rgba(216, 0, 29, 0.12); color: #FF4D5E; border: 1px solid rgba(216, 0, 29, 0.3); font-size: 0.75rem; font-weight: 700;">
        ADVANCED PHOTO-AGING & CELLULAR OXIDATION
      </span>
      <h2 class="display-6 fw-bold text-white mb-3">Why Skin Creams & Vitamins <span class="text-danger">Fail from the Outside</span></h2>
      <p class="text-secondary">UV radiation and free radicals penetrate deep into skin fibroblasts and DNA strands. Topical creams merely sit on dead surface layers without repairing internal cellular structure.</p>
    </div>
    ...
    <div class="row g-4 mb-5">
      <div class="col-md-4">
        <div class="ps-problem-card">
          ...
          <h4 class="text-white fw-bold fs-5 mb-2">Solar UVA/UVB Radiation</h4>
          <p class="text-secondary small mb-0">Sunlight generates aggressive singlet oxygen that degrades collagen scaffolds, triggering premature hyperpigmentation, deep wrinkles, and DNA strand breaks.</p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="ps-problem-card">
          ...
          <h4 class="text-white fw-bold fs-5 mb-2">Depleted Endogenous Glutathione</h4>
          <p class="text-secondary small mb-0">After age 30, the liver’s production of master antioxidants drops sharply, leaving bodily tissues vulnerable to environmental toxicity and cellular discoloration.</p>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="ps-problem-card">
          ...
          <h4 class="text-white fw-bold fs-5 mb-2">Poor Oral Bioavailability</h4>
          <p class="text-secondary small mb-0">Standard ingestible collagen and synthetic carotenoid pills suffer poor hepatic breakdown, delivering virtually zero active protection to cellular nuclei.</p>
        </div>
      </div>
    </div>
    ...
    <div class="p-4 p-md-5 rounded-4 position-relative overflow-hidden" style="background: radial-gradient(circle at 10% 50%, rgba(216,0,29,0.15) 0%, rgba(18,19,24,0.95) 100%); border: 1px solid rgba(216,0,29,0.3);">
      <div class="row align-items-center g-4">
        <div class="col-lg-8">
          <span class="badge px-3 py-1 rounded-pill mb-2" style="background: #2ECC71; color: #000; font-weight: 800; font-size: 0.72rem;">PHOTO-NUTRIENT DNA PROTECTION</span>
          <h3 class="text-white fw-bold display-6 fs-3 mb-3">How Crystal Cell™ Protects and Illuminates Your Cells</h3>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="benefits">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">6 Core Transformations from <span class="text-gold">Crystal Cell™</span></h2>
      <p class="text-secondary">Fortified with colorless carotenoids and Burgundian grape stem cells for systemic rejuvenation and deep cellular photoprotection.</p>
    </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="ps-benefit-card">
            <div class="ps-benefit-icon-box">
              <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
            </div>
...
<section class="py-5 position-relative" style="background: #101116;" id="comparison">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Conventional Anti-Aging vs <span class="text-gold">Crystal Cell™</span></h2>
      <p class="text-secondary">Compare standard skin treatments with internally delivered sublingual photo-protection.</p>
    </div>
      ...
      <table class="ps-compare-table">
        <thead>
          <tr>
            ...
            <th style="width: 35%; color: #8C8E99;">Standard Topicals & Oral Pills</th>
            <th class="highlight-col" style="width: 35%; font-size: 1.05rem;">
              <span class="text-gold">★</span> Crystal Cell™
            </th>
          </tr>
        </thead>
        <tbody>
    ...
    <div class="text-center max-w-700 mx-auto mb-4">
      ...
      <p class="text-secondary small">Clinically verified ingredients extracted through patented Swiss biochemistry.</p>
    </div>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="gallery">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Crystal Cell™ <span class="text-gold">Visual Showcase</span></h2>
    ...
    <div class="row g-4 justify-content-center">
      <div class="col-lg-3 col-6">
        <div class="ps-gallery-card js-image-trigger" data-img-src="<?= asset(ltrim($product['image'], '/')) ?>" data-img-caption="Crystal Cell™ — Official Packaging & Holographic Seal">
          <img src="<?= asset(ltrim($product['image'], '/')) ?>" alt="Crystal Cell Box" loading="lazy">
      ...
      <div class="col-lg-3 col-6">
        <div class="ps-gallery-card js-image-trigger" data-img-src="<?= asset('images/testimonies/lump-healed.jpg') ?>" data-img-caption="Documented Physical Transformation and Cellular Healing with PhytoScience">
          <img src="<?= asset('images/testimonies/lump-healed.jpg') ?>" alt="Transformation Proof" loading="lazy">
          <div class="ps-gallery-zoom-overlay">
            <div class="ps-gallery-zoom-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line><line x1="11" y1="8" x2="11" y2="14"></line><line x1="8" y1="11" x2="14" y2="11"></line></svg>
            </div>
  ...
  <div class="container">
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-7">
        ...
        <h2 class="display-6 fw-bold text-white mb-3">How to Take for <span class="text-gold">Maximum Bio-Availability</span></h2>
        <p class="text-secondary mb-4">Pour directly under your tongue each morning. Salivary mucosal enzymes absorb the active phyto-nutrients straight into cellular circulation.</p>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="video-proof">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <p class="text-secondary">Watch genuine video accounts of skin restoration and wellness transformations with Crystal Cell™.</p>
    </div>
...
<section class="py-5 position-relative" style="background: #101116;" id="reviews">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <p class="text-secondary">Read authentic feedback on skin radiance, joint relief, and cellular rejuvenation.</p>
    </div>
...
<section class="py-5 position-relative" style="background: #0A0B0E;" id="faq">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <h2 class="display-6 fw-bold text-white mb-3">Everything You Need to Know About <span class="text-crimson">Crystal Cell™</span></h2>
...
<section class="py-5 py-lg-6 position-relative text-center overflow-hidden" style="background: radial-gradient(circle at 50% 50%, rgba(216,0,29,0.22) 0%, rgba(10,11,14,0.98) 75%); border-top: 1px solid rgba(216,0,29,0.3); border-bottom: 1px solid rgba(216,0,29,0.3);">
  <div class="container">
    <div class="max-w-800 mx-auto">
      ...
      <h2 class="display-5 fw-bold text-white mb-3">Begin Your Transformation with <span class="text-crimson">Crystal Cell™</span></h2>
      <p class="text-secondary lead fs-6 mb-4">
        Unlock DNA-level defense and youthful skin radiance powered by Swiss PhytoCellTec™ plant stem cell science.
      </p>
      ...
      <div class="d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4">
        ...
        <a href="https://wa.me/2348023173303?text=<?= urlencode('Hello PhytoScience Team, I am on the Crystal Cell page and would like to order or consult.') ?>" target="_blank" rel="noopener" class="btn-ps btn-ps-emerald py-3 px-4 fs-6 fw-bold">
