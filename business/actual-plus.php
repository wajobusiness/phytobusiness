...
<section class="py-5 position-relative" style="background: #101116;" id="pricing-packages">
  <div class="container">
    <div class="text-center max-w-700 mx-auto mb-5">
      ...
      <p class="text-secondary mb-3">Select your package below to lock in promotional discounts. Free doorstep delivery and payment on delivery available across Lagos and Abuja.</p>
